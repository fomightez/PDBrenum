...
Launch directly into [a companion notebook demonstrating mapping chain identifiers to UniProt identifiers by clicking here](https://mybinder.org/v2/gh/fomightez/PDBrenum/pandas2?filepath=chainID_mapping_to_UniProt_id_demo.ipynb).
